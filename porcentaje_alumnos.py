cant_ninas = int(input("Cantidad niñas: "))
cant_ninos = int(input("Cantidad niños: " ))
total_alumnos = cant_ninos + cant_ninas

porcentaje_ninos = (cant_ninos / total_alumnos) * 100
